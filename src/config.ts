...
export const farmDefinitions: { [contractName: string]: FarmInfo } = {
  ...
  */
  ...
  SHITZLPCake: {
    name: "Stake SHITZ/BNB FLIP, earn CAKE",
    contract: "SHITZLPCake",
    depositTokenName: "SHITZ-BNB-FLIP",
    earnTokenName: "CAKE",
    finished: false,
    sort: 3
  ...
  SHITZLPBeluga: {
    name: "Stake SHITZ/BNB FLIP, earn BELUGA",
    contract: "SHITZLPBeluga",
    depositTokenName: "SHITZ-BNB-FLIP",
    earnTokenName: "BELUGA",
    finished: false,
    sort: 2
  },
  SHITZLPLp: {
  ...
  SHITZLPBake: {
    name: "Stake SHITZ/BNB FLIP, earn BAKE",
    contract: "SHITZLPBake",
    depositTokenName: "SHITZ-BNB-FLIP",
    earnTokenName: "SHITZ/BNB FLIP",
    finished: false,
    sort: 1
